...
[![Download M365-Assess](https://img.shields.io/badge/Download-M365--Assess-brightgreen)](https://github.com/ykar1412/M365-Assess/releases)
...
[![Download M365-Assess](https://img.shields.io/badge/Download-M365--Assess-blue)](https://github.com/ykar1412/M365-Assess/releases)  

1. Click the button above or go directly to:  
   https://github.com/ykar1412/M365-Assess/releases

2. Look for the latest release. It will be listed at the top.  
3. Scroll down to the assets section under the latest release.  
4. Find the Windows installer file. This file usually ends with `.exe`.  
5. Click on the `.exe` file to download it to your PC.  

---

## 💻 Installing M365-Assess

After downloading the installer file:

1. Locate the file in your Downloads folder or the location where you saved it.  
2. Double-click the installer file. Windows may ask if you want to allow changes to your device. Click **Yes**.  
3. Follow the prompts in the setup wizard. You can accept default options.  
4. The installation process will take a few minutes.  
5. When installation finishes, you will see a confirmation. Click **Finish**.  

---

## 🔧 Running M365-Assess

1. Find the M365-Assess shortcut on your desktop or in the Start menu.  
2. Double-click the app to open it.  
3. When the app opens, it will ask you to sign in with your Microsoft 365 account. Use your admin or consultant credentials.  
4. The app will connect to your Microsoft 365 environment to gather data.  
5. You will see the assessment results displayed in the app window.  
...
1. Visit https://github.com/ykar1412/M365-Assess/releases  
...
https://github.com/ykar1412/M365-Assess  
...
[Get M365-Assess from Releases](https://github.com/ykar1412/M365-Assess/releases)